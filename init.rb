...
if (Autoproj.user_config('use_deb')) then
	...
	Autobuild.env_add_path('PATH','/opt/rock/bin')
	...
	Autobuild.env_add_path('RUBYLIB','/opt/rock/lib/ruby/vendor_ruby/')
	...
	Autobuild.env_add_path('RUBYLIB','/opt/rock/lib/ruby/1.9.1')
	Autobuild.env_add_path('RUBYLIB','/usr/lib/ruby/vendor_ruby')
	Autobuild.env_add_path('RUBYLIB','/opt/rock/lib/ruby/1.9.1/x86_64-linux')
	Autobuild.env_add_path('ROCK_TEMPLATE_PREFIX','/opt/rock/chare/rock/templates/')
